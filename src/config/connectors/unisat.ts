...
import { WalletNetwork, Balance } from "../../types/btc";
...
export namespace UnisatWalletTypes {
  export type AccountsChangedEvent = (
    ...
    handler: (accounts: Array<string> | undefined) => void
  ) => void;
...
export class UnisatConnector extends BtcConnector {
  ...
  readonly logo: string =
    "https://raw.githubusercontent.com/IceHugh/btc-connect/main/src/assets/Unisat%20logo.svg";
