    ...
    return (
        <div className="flex justify-between bg-[#181924] p-6 border-[0.5px] border-[#FFFFFF1A] w-full lg:w-3/4 mx-auto min-w-sm rounded-xl bg-card-background">
            <div className="flex flex-col items-center">
                ...
                <Text className={` ${active >= 1 ? `text-white` : `text-[#90A3BF]`} text-center`}>Token <br /> Information</Text>
            </div>
            <hr className={`mt-4 ${active > 1 ? `bg-[#F23F5D] border-[#F23F5D]` : `bg-[#0E0F19] border-[#0E0F19]`} h-px border-t-2 w-2/5`} />
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 2 ? `text-white` : `text-[#90A3BF]`}>Amount</Text>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 3 ? `text-white` : `text-[#90A3BF]`}>Confirmation</Text>
            </div>
        </div>
    )
}