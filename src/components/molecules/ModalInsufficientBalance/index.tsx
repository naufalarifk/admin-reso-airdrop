...
interface ModalInsufficientBalanceProps {
    isOpen: boolean;
    closeModal: () => void;
}

export const ModalInsufficientBalance = ({ isOpen, closeModal }: ModalInsufficientBalanceProps) => {
