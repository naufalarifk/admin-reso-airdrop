    ...
    return (
        <div className="flex justify-center bg-[#181924] p-6 border-[0.5px] border-[#FFFFFF1A] w-full lg:w-3/4 mx-auto min-w-sm rounded-xl bg-card-background">
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 1 ? `text-white` : `text-[#90A3BF]`}>{t('bridge.step.first')}</Text>
            </div>
            <hr className={`mt-4 ${active > 1 ? `bg-[#F23F5D] border-[#F23F5D]` : `bg-[#0E0F19] border-[#0E0F19]`} h-px border-t-2 w-1/5`} />
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 2 ? `text-white` : `text-[#90A3BF]`}>{t('bridge.step.second')}</Text>
            </div>
            <hr className={`mt-4 ${active > 2 ? `bg-[#F23F5D] border-[#F23F5D]` : `bg-[#0E0F19] border-[#0E0F19]`} h-px border-t-2 w-1/5`} />
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 3 ? `text-white` : `text-[#90A3BF]`}>{t('bridge.step.third')}</Text>
            </div>
            <hr className={`mt-4 ${active > 3 ? `bg-[#F23F5D] border-[#F23F5D]` : `bg-[#0E0F19] border-[#0E0F19]`} h-px border-t-2 w-1/5`} />
            <div className="flex flex-col items-center">
                ...
                <Text className={active === 4 ? `text-white` : `text-[#90A3BF]`}>{t('bridge.step.fourth')}</Text>
            </div>
        </div>
    )
}