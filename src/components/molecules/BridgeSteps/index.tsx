    ...
    return (
        <div className="flex justify-center bg-[#181924] p-6 border-[0.5px] border-[#FFFFFF1A] w-full lg:w-3/4 mx-auto min-w-sm rounded-xl bg-card-background">
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 1 ? `text-white` : `text-[#90A3BF]`}>Import</Text>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 2 ? `text-white` : `text-[#90A3BF]`}>Review</Text>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <Text className={active >= 3 ? `text-white` : `text-[#90A3BF]`}>Confirm</Text>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <Text className={active === 4 ? `text-white` : `text-[#90A3BF]`}>Receive</Text>
            </div>
        </div>
    )
}