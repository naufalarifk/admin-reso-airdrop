                              ...
                              <li key={i}>
                                 {item.code === 'docs' ? (
                                    ...
                                    <div
                                       ...
                                       className="flex cursor-pointer items-center gap-3 rounded-full bg-primary px-4 py-2 font-semibold text-white">
                                       Create New Market
                                    </div>
                                 ) : (
                                    <NavLink
