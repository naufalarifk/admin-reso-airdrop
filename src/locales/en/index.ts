      ...
      info: {
         phaseOne: {
            ...
            list: {
               ...
               three: 'Seamlessly swap cryptocurrencies with our user-friendly interface, making crypto exchanges effortless and stress-free. ',
            },
         },
         phaseTwo: {
            title: {
            ...
            list: {
               ...
               three: 'Take your earnings to new heights with optional additional crypto rewards through our staking program, maximizing the potential of your assets.',
            },
         },
      },
      provider: {
         ...
         section: {
          ...
          use our services.`,
            ...
            five: {
               ...
               subtitle: {
                  one: {
                     heading: '5.1. Rectoverso is committed to protecting user privacy',
      ...
      body: {
         section: {
            ...
            five: {
               ...
               subtitle: {
                  one: {
                     heading: '5.1. Rectoverso uses cookies to improve user experience',
