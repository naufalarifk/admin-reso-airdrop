import { IcDocuments, IcMedium, IcTwitter } from '@/assets/icons';
import { CountdownTime, NumberInput, TabSlider } from '@/components';
...
export const Launchpad = () => {
   ...
   return (
      <section className="relative mx-auto  w-[95%] max-w-[85rem] py-10">
         {/* Header Launchpad */}
         ...
         <div className="flex gap-4">
            <div className="flex h-full w-9/12 flex-col gap-6">
               <div className="relative flex h-full max-h-[350px] flex-col justify-center overflow-hidden rounded-2xl bg-dark2 p-6">
                  <img
                     src="/images/banner-launchpad.webp"
                     alt=""
                  />
